...
def main():
    ...
    if config.DATASET.DATASET == 'splicing_dataset':
        ## CHOOSE ##
        train_dataset = splicing_dataset(crop_size=crop_size, grid_crop=True, blocks=('RGB', 'DCTvol', 'qtable'), mode='train', DCT_channels=1, read_from_jpeg=True, class_weight=[0.5, 2.5], user_data_root=user_data_root)  # full model
        # train_dataset = splicing_dataset(crop_size=crop_size, grid_crop=True, blocks=('DCTvol', 'qtable'), mode='train', DCT_channels=1, read_from_jpeg=True, class_weight=[0.5, 2.5], user_data_root=user_data_root)  # only DCT stream
    ...
    # validation
    ## CHOOSE ##
    valid_dataset = splicing_dataset(crop_size=None, grid_crop=True, blocks=('RGB', 'DCTvol', 'qtable'), mode="valid", DCT_channels=1, read_from_jpeg=True, user_data_root=user_data_root)  # full model
    # valid_dataset = splicing_dataset(crop_size=None, grid_crop=True, blocks=('DCTvol', 'qtable'), mode="valid", DCT_channels=1, read_from_jpeg=True, user_data_root=user_data_root)  # only DCT stream
